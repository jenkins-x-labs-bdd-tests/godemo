...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-labs-bdd-tests/godemo/master/1'
...
export MINK_IMAGE='ghcr.io/jenkins-x/godemo:0.0.28'
